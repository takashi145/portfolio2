    ...
    <div class="max-w-7xl mx-auto pb-8">
      ...
      <div class="mb-8 mx-auto max-w-screen-xl text-center">
        ...
        <div class="mb-5 flex justify-center">
          <img src="https://avatars.githubusercontent.com/u/84027833?s=400&u=2a47f99db63cdd16478f99daa60b84978ab44c85&v=4" alt="profile" class="rounded-full h-32 w-32 ring-4">
        </div>

        <p class="mb-3 font-normal text-gray-800 lg:text-lg sm:px-16 lg:px-48 dark:text-gray-400">
          高橋周平
        </p>
      ...
      <div class="space-y-14">
        ...
        <div id="skill" class="text-center mx-6 lg:mx-24">
          ...
          <div class="custom-scrollbar grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 border-b border-gray-500 p-8 max-h-screen overflow-y-auto">
            <SkillCard 
