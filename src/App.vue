  ...
  <div class="min-h-screen bg-gray-100 dark:bg-slate-800">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="mx-auto max-w-screen-xl text-center p mb-8">
        ...
        <!-- GitHub Link -->
        <a href="https://github.com/takashi145" class="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center border dark:border-gray-600 dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mb-6">
      ...
      <div class="space-y-14">
        ...
        <div class="text-center mx-auto max-w-3xl">
          ...
          <div 
            ...
            :key="index" 
            class="group relative inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2"
          >
            #{{ skill.name }}
          </div>
        </div>
