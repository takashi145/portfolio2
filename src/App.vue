...
const isInViewportProduct = ref(false); // idが#productの位置にいるか

// idが#skillの位置と#productの位置にいる時の処理
const  checkElementInViewport = () => {

  const skillElement = document.getElementById('skill')!;
  const skillPosition = skillElement.getBoundingClientRect();
  const productElement = document.getElementById('product')!;
  const productPosition = productElement.getBoundingClientRect();

  // #skillの位置にいる場合
  if (skillPosition.top <= window.innerHeight && skillPosition.top >= 0) {
    isInViewportSkill.value = true;
    isInViewportProduct.value = false;
  // #productの位置にいる場合
  } else if (productPosition.top <= window.innerHeight && productPosition.top >= 0) {
    isInViewportProduct.value = true;
    isInViewportSkill.value = false;
  }
}
  ...
  <div class="min-h-screen bg-gray-100 dark:bg-slate-800 selection:text-blue-500 dark:selection:text-green-400">
    ...
    <div class="max-w-7xl mx-auto pb-8">
      ...
      <div class="mx-auto max-w-screen-xl text-center">
        ...
        <!-- <p class="mb-1 font-normal text-gray-800 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">
          CIT NS4
        </p> -->
        <p class="mb-3 text-sm font-normal text-gray-800 lg:text-lg sm:px-16 lg:px-48 dark:text-gray-400">
          高橋周平
        </p>

        <!-- GitHubのリンク -->
        <a href="https://github.com/takashi145" target="_blank" rel="noopener noreferrer" class="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center border dark:border-gray-600 dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mb-3">
      ...
      <div class="w-full sticky top-0 bg-gray-100 dark:bg-slate-800 py-3 mb-8 z-40 border-b border-gray-300 dark:border-gray-600">
        <ul class="flex items-center justify-center space-x-6 text-gray-600 dark:text-white">
          <li>
      ...
      <div class="space-y-14">
        ...
        <div id="skill" class="text-center mx-6 lg:mx-24">
          ...
          <div class="custom-scrollbar grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 border-b border-gray-500 p-8 max-h-screen overflow-y-auto">
            <SkillCard 
